...
the [2026-07-28 system audit](architecture.md).
...
Measured with `benchmarks/ekp-bench.el` (batch Emacs 30.2, Apple Silicon,
...
power state; regenerate them with the two commands in docs/architecture.md §9.
